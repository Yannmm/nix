...

{
  services.aerospace = {
    ...
    settings = {
      ...
      # AeroSpace startup is managed by nix-darwin/launchd.
      # Do not set start-at-login here.
      ...
      # Callback when binding mode changes
      on-mode-changed = [];
      ...
      mode.main.binding = {
        ...
        # Workspaces A-Z (selected persistent workspaces)
        alt-a = "workspace A";
        alt-b = "workspace B";
        alt-c = "workspace C";
        alt-d = "workspace D";
